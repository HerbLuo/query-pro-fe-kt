...
public class UserQueryPro {
    ...
    public static QueryPro<User, Long, __Impl.WhereField<User, List<User>>, __Impl.OrderByField<User, List<User>>, __Impl.UpdateSetField, __Impl.WhereField<Boolean, Boolean>, __Impl.WhereField<Boolean, Boolean>> setBeautifySql(boolean beautifySql) {
        return queryPro.setBeautifySql(beautifySql);
    }

    public static QueryPro<User, Long, __Impl.WhereField<User, List<User>>, __Impl.OrderByField<User, List<User>>, __Impl.UpdateSetField, __Impl.WhereField<Boolean, Boolean>, __Impl.WhereField<Boolean, Boolean>> setDataSource(javax.sql.DataSource dataSource) {
        return queryPro.setDataSource(dataSource);
    }

    public static QueryPro<User, Long, __Impl.WhereField<User, List<User>>, __Impl.OrderByField<User, List<User>>, __Impl.UpdateSetField, __Impl.WhereField<Boolean, Boolean>, __Impl.WhereField<Boolean, Boolean>> setDryRun(boolean dryRun) {
        return queryPro.setDryRun(dryRun);
    }

    public static QueryPro<User, Long, __Impl.WhereField<User, List<User>>, __Impl.OrderByField<User, List<User>>, __Impl.UpdateSetField, __Impl.WhereField<Boolean, Boolean>, __Impl.WhereField<Boolean, Boolean>> setLogicDelete(boolean logicDelete) {
        return queryPro.setLogicDelete(logicDelete);
    }

    public static QueryPro<User, Long, __Impl.WhereField<User, List<User>>, __Impl.OrderByField<User, List<User>>, __Impl.UpdateSetField, __Impl.WhereField<Boolean, Boolean>, __Impl.WhereField<Boolean, Boolean>> setLogicDeleteField(String logicDeleteField) {
        return queryPro.setLogicDeleteField(logicDeleteField);
    }

    public static QueryPro<User, Long, __Impl.WhereField<User, List<User>>, __Impl.OrderByField<User, List<User>>, __Impl.UpdateSetField, __Impl.WhereField<Boolean, Boolean>, __Impl.WhereField<Boolean, Boolean>> setPrintCallByInfo(boolean printCallByInfo) {
        return queryPro.setPrintCallByInfo(printCallByInfo);
    }

    public static QueryPro<User, Long, __Impl.WhereField<User, List<User>>, __Impl.OrderByField<User, List<User>>, __Impl.UpdateSetField, __Impl.WhereField<Boolean, Boolean>, __Impl.WhereField<Boolean, Boolean>> setPrintResult(boolean printResult) {
        return queryPro.setPrintResult(printResult);
    }

    public static QueryPro<User, Long, __Impl.WhereField<User, List<User>>, __Impl.OrderByField<User, List<User>>, __Impl.UpdateSetField, __Impl.WhereField<Boolean, Boolean>, __Impl.WhereField<Boolean, Boolean>> setPrintSql(boolean printSql) {
        return queryPro.setPrintSql(printSql);
    }

    public static QueryPro<User, Long, __Impl.WhereField<User, List<User>>, __Impl.OrderByField<User, List<User>>, __Impl.UpdateSetField, __Impl.WhereField<Boolean, Boolean>, __Impl.WhereField<Boolean, Boolean>> setQueryProFieldComment(boolean queryProFieldComment) {
        return queryPro.setQueryProFieldComment(queryProFieldComment);
    }

    public static QueryPro<User, Long, __Impl.WhereField<User, List<User>>, __Impl.OrderByField<User, List<User>>, __Impl.UpdateSetField, __Impl.WhereField<Boolean, Boolean>, __Impl.WhereField<Boolean, Boolean>> setQueryStructureResolver(IQueryStructureResolver queryStructureResolver) {
